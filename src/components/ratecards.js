...
const RateCards = () =>{
    ...
    if(api){
        content =
            <div className="ratecards-container row  col-12  ">
                <div className="usdcard card col-md-3  my-4 col-xs-5">
                ...
                <div className="gbpcard card col-md-3 col-xs-5 my-4"> 
                ...
                <div className="eurcard card col-md-3 col-xs-5 my-4"> 
